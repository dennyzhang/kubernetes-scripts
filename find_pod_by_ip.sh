...
## --
## Created : <2018-01-04>
## Updated: Time-stamp: <2018-01-04 23:49:52>
##-------------------------------------------------------------------
set -e
...
# (echo pod_ip="172.42.42.1"; \
#    curl -L https://raw.githubusercontent.com/DennyZhang/kubernetes-scripts/master/find_pod_by_ip.sh) \
#   | bash
